...
(function($) {
	...
	$(document).bind('EntwineElementsAdded', function(e){
		...
		for (var k in $.entwine.namespaces) {
			var namespace = $.entwine.namespaces[k];
			if (namespace.injectee && namespace.injectee.onadd) namespace.injectee.onadd.call(e.targets);
		}
	});
	...
	$(document).bind('EntwineElementsRemoved', function(e){
		for (var k in $.entwine.namespaces) {
			var namespace = $.entwine.namespaces[k];
			if (namespace.injectee && namespace.injectee.onremove) namespace.injectee.onremove.call(e.targets);
		}
	});
