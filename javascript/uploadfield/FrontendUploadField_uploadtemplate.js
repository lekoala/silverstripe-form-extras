window.tmpl.cache['ss-frontenduploadfield-uploadtemplate'] = tmpl(
			...
			'<div class="ss-uploadfield-item-info">' +
				...
				'<div class="ss-uploadfield-item-actions">' + 
					...
					'<div class="ss-uploadfield-item-cancel cancel">' +
						'<button title="' + ss.i18n._t('UploadField.CANCELREMOVE', 'Cancel/Remove') + '">' + ss.i18n._t('UploadField.CANCELREMOVE', 'Cancel/Remove') + '</button>' +
					'</div>' +
				'</div>' +
			'</div>' +
		'</li>' + 
