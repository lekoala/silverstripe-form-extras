...
if (!CKEDITOR.embedType) {
    CKEDITOR.embedType = 'Embed';
}
CKEDITOR.editorConfig = function (config) {
    ...
    config.toolbar_full = [{
        ...
        {
            name: 'insert',
            items: ['Image', CKEDITOR.embedType, 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'Iframe']
        },
        '/',
        {
            name: 'styles',
    ...
    config.toolbar_advanced = [{
            name: 'clipboard',
            items: ['Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Maximize', 'ShowBlocks']
        },
        {
            name: 'basicstyles',
        ...
        {
            name: 'insert',
            items: ['Link', 'Image', CKEDITOR.embedType, 'Table', 'HorizontalRule', 'Smiley', 'Iframe']
        }
    ];
    config.toolbar_advanced2 = [{
            name: 'clipboard',
            items: ['Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Maximize', 'ShowBlocks', 'SelectAll']
        },
        {
            name: 'basicstyles',
